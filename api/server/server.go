...
func New(ctx context.Context, ds models.Datastore, mq models.MessageQueue, r *runner.Runner, cacher routecache.Cacher, tasks chan runner.TaskRequest, enqueue models.Enqueue) *Server {
	Api = &Server{
		Runner:    r,
		Router:    gin.New(),
		Datastore: ds,
